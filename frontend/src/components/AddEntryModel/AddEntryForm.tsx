...
const AddEntryForm = ({ onCancel, onSubmit }: Props) => {
    ...
    return (
        <div>
            ...
            >
                <MenuItem value="SelectEntry" key="SelectEntry" disabled selected>
                   Select Entry
                </MenuItem>
                ...
                {entryOptions === "HealthCheck" && 
                    <>
                       <InputLabel style={{ marginTop: 20 }}>HealthCheckRating</InputLabel>
                        ...
                        >
                            <MenuItem value="SelectHealthCheck" key="SelectHealthCheck" disabled selected>
                                Select Health Check Rating
                            </MenuItem>
